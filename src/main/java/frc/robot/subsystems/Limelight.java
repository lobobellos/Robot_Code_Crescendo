...
public class Limelight extends SubsystemBase {
  ...
  public Limelight(String limelightName) {
    ...
    m_TvSub =
        m_table.getDoubleTopic("tv").subscribe(LimelightConstants.defaultReturnValue);
    m_TxSub =
        m_table.getDoubleTopic("tx").subscribe(LimelightConstants.defaultReturnValue);
    m_TySub =
        m_table.getDoubleTopic("ty").subscribe(LimelightConstants.defaultReturnValue);
    m_TaSub =
        m_table.getDoubleTopic("ta").subscribe(LimelightConstants.defaultReturnValue);
    m_TsSub =
        m_table.getDoubleTopic("ts").subscribe(LimelightConstants.defaultReturnValue);
    m_ThorSub =
        m_table.getDoubleTopic("thor").subscribe(LimelightConstants.defaultReturnValue);
    m_TvertSub =
        m_table.getDoubleTopic("tvert").subscribe(LimelightConstants.defaultReturnValue);
  ...
  public double getInchesFromTarget() {
    ...
    double heightDifference =
        LimelightConstants.mountingHeightInches
            - LimelightConstants.targetFloorHeight;
